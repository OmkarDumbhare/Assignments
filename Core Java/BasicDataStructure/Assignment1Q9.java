...
class Students {
    ...
    public int [] subjectWiseMarks(Students[] student,String sub){
        int [] arr = new int[3];
        if(sub.equals("A")){
    ...
    public int studentsTotalMarksInAllSubjects(Students[] students) {
    ...
    public double studentsAverageMarksInAllSubjects(Students[] students) {
        int total=0;
        for(int i=0;i<students.length;i++){
            total = total+students[i].subjectA+students[i].subjectB+students[i].subjectC;
...
public class Assignment1Q9 {
    public static void main(String[] args) {
        Students s1 = new Students(10,20,30);


        Students s2 = new Students(10,20,30);


        Students s3 = new Students(10,20,30);
